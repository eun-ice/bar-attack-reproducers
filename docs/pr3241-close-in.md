...
Headless runs of BAR overlays (gadget, start scripts and runner in my workspace, `aimfrom-estimate/close-in/`), BAR `feature/aim-from-estimate` (beyond-all-reason/Beyond-All-Reason#9090). "baseline" = #3325 + #3327 without the fix commits. Five Sheldons per run, `targetHits` and `moved` (elmos) per unit at frame 800:
...
**Rock, maneuver: this branch.** All five walk out and stop once they have a shot.

https://github.com/user-attachments/assets/42aa0439-a162-4770-8412-2ff6f19d4c52
